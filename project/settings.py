...
# Django Allauth Configuration (updated for django-allauth 0.65+)
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'noreply@lms.com')

# Site URL for email links (use environment variable or default)
SITE_URL = os.getenv('SITE_URL', 'http://localhost:8500')
